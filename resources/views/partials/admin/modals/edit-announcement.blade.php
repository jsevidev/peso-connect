<div id="modal-edit-announcement" class="admin-modal-backdrop" role="dialog" aria-modal="true" aria-labelledby="modal-edit-announcement-title">
  <div class="admin-modal admin-modal--announcement">
    <form action="{{ route('admin.announcements.update') }}" method="POST">
      ...
      <div class="admin-modal__header">
        <div>
          <h2 id="modal-edit-announcement-title" class="admin-modal__title">Edit Announcement</h2>
          <p class="admin-modal__subtitle">Update the announcement details below.</p>
        </div>
      ...
      <div class="admin-modal__body">
        @include('partials.admin.modals.announcement-form-fields', ['prefix' => 'edit'])
      </div>
