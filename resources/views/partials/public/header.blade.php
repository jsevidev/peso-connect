...
@endphp
<header id="public-header" class="public-header" data-turbo-permanent style="background-color: #fff;display: flex;flex-direction: row;grid-column-gap: 0px;align-items: center;justify-content: center;height: 80px;position: relative;flex-shrink: 0;">
  <a href="{{ route('home') }}" class="public-brand" style="display: flex;flex-direction: row;grid-column-gap: 12px;align-items: center;justify-content: flex-start;width: min-content;position: relative;flex-shrink: 0;margin: 0px auto 0px 0px;text-decoration: none;">
    <div style="overflow: hidden;border-radius: 20px;display: flex;flex-direction: column;row-gap: 0px;align-items: start;justify-content: flex-start;width: 40px;height: 40px;position: relative;flex-shrink: 0;"><img src="{{ asset('assets/img/peso-logo.png') }}" alt="PESO seal logo" width="40" height="40" decoding="async" fetchpriority="high" style="inset: 0;width: 100%;height: 100%;position: absolute;object-fit: cover;"></div>
